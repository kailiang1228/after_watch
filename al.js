document.addEventListener('DOMContentLoaded', function() {
    ...
    const initialData = {
        ...
        drama: ['紙房子', '絕命毒師', '痞子英雄_5', '新邊珠格格', '越獄風雲', '城市的主宰', '東京罪惡', '黑道家族', '火線', '巔峰對決2023、24', '惠美李藝彩派', 'PROUDCE 48', '大谷翔平:超越夢想', '切爾諾貝利', '勇者義彥'],
        animation: ['雙城之戰', '銀魂', '烏龍派出所', '探險活寶', '鋼彈SEED', '賽馬娘OVA', 'U149', '少女與戰車', '五等分', '未聞花名', '四月妹妹', '涼宮', '魯路修', '法蘭秀秀', '入間同學', '我內心的糟糕念頭', '農夫戰紀', '天國大魔境', '躍動青春', '我家英雄', '無頭騎士', '鍊鋸人', '清音社', '新石記', '四月謊言', 'Z鋼 33', '鋼鍊37', '夢幻島']
    };
